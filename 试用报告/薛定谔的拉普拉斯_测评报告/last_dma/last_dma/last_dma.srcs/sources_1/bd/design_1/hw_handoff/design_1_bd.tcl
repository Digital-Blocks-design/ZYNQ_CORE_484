...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net AXI_FULL_0_M_AXI [get_bd_intf_pins AXI_FULL_0/M_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axI_lite_slave_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net axI_lite_slave_0_SIGN [get_bd_pins AXI_FULL_0/input_signal] [get_bd_pins axI_lite_slave_0/SIGN]
  connect_bd_net -net axI_lite_slave_0_dst_addr [get_bd_pins AXI_FULL_0/dst_addr] [get_bd_pins axI_lite_slave_0/dst_addr]
  connect_bd_net -net axI_lite_slave_0_size [get_bd_pins AXI_FULL_0/size] [get_bd_pins axI_lite_slave_0/size]
  connect_bd_net -net axI_lite_slave_0_src_addr [get_bd_pins AXI_FULL_0/src_addr] [get_bd_pins axI_lite_slave_0/src_addr]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_FULL_0/ACLK] [get_bd_pins axI_lite_slave_0/ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn1 [get_bd_pins AXI_FULL_0/ARESETN] [get_bd_pins axI_lite_slave_0/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces AXI_FULL_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axI_lite_slave_0/S_AXI/reg0] SEG_axI_lite_slave_0_reg0
